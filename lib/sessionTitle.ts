...
function languageInstruction(preferredLanguage: string): string {
  switch (preferredLanguage) {
    case "zh-Hans":
    case "zh":
      return "Write the title in natural Simplified Chinese (e.g. 「留柏林还是留下」, 「布朗还是康奈尔」) — not a word-for-word English translation."
    case "es":
      return "Write the title in natural Spanish (e.g. «Berlín o quedarme», «Brown o Cornell») — not a word-for-word English translation."
    case "fr":
      return "Write the title in natural French (e.g. «Berlin ou rester», «Brown ou Cornell») — not a word-for-word English translation."
    default:
